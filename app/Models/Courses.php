...
class Courses extends Model
{
    ...
    */
    ...
    protected $fillable = ['name','short_description','description1','image1','description2','image2','images','videos','slug','id_category','file'];
    protected $translatable = ['name','short_description','description1','description2'];
    // protected $fillable = [];
    // protected $hidden = [];
    // protected $dates = [];
